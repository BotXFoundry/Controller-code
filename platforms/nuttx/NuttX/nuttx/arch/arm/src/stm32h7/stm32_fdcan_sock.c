...
int fdcan_initialize(struct fdcan_driver_s *priv)
{
  ...
  //printf("###1: priv->base = %u\n", priv->base);
  //printf("###1: STM32_FDCAN_SIDFC_OFFSET, cary test regval = %u\n", regval);
  ram_offset += n_stdid;
  ...
  //printf("###2: priv->base = %u\n", priv->base);
  //printf("###2: STM32_FDCAN_XIDFC_OFFSET, cary test regval = %u\n", regval);
  ram_offset += n_extid;
  ...
  regval |= FDCAN_GFC_ANFE;
  //printf("###3: priv->base = %u\n", priv->base);
  //printf("###3: STM32_FDCAN_GFC_OFFSET, cary test regval = %u\n", regval);
